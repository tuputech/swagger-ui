  ...
  render() {
    ...
    return (
      <div>
        ...
        <Button className={`btn btn-sm json-schema-form-item-add ${errors.length ? "invalid" : null}`} onClick={this.addItem} data-value={List.isList(this.state.value)}> Add item </Button>
      </div>
    )
  }
}
